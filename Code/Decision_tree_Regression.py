...
dataset = shuffle(np.array(pd.read_csv(r"C:\Users\Admin\OneDrive\Desktop\SahilROSP\Breast_Cancer_Detection\dataset.csv",header=1)))

#data frame
logging.info("*** CLEANING DATAFRAME ***")
data_frame = pd.read_csv(r"C:\Users\Admin\OneDrive\Desktop\SahilROSP\Breast_Cancer_Detection\dataset.csv",header=1)
