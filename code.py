...
def init():
    ...
    df=pd.read_csv(r"C:\Users\Admin\OneDrive\Desktop\Breast-Cancer-Prediction-Using-Logistic-Regression-master\Breast-Cancer-Prediction-Using-Logistic-Regression-master\dataset.csv")
